...
public class BlockState {
	 ...
	 * @pre | size.getX() == blockBR.getX() - blockTL.getX() 
	 * @pre | size.getY() == blockBR.getY() - blockTL.getY()
	 * @post | result != null
	...
	public Point getBlockTL() {
		return new Point(this.blockTL.getX(),this.blockTL.getY());
	}
	/**
	 * 
	 * @inspects | this
	...
	public Point getBlockBR() {
		...
		return new Point(this.blockBR.getX(),this.blockBR.getY());
	}
	 ...
	 * @post | TL.equals(result.getBlockTL())
	 * @post | BR.equals(result.getBlockBR())
	 */
	public BlockState setBlockTLBR(Point TL, Point BR) {
		...
		return BlockState.valueOf(TLCopy, BRCopy, new Vector(BR.getX()-TL.getX(),BR.getY()-TL.getY()));
	}
