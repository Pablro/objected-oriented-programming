...
public class BreakoutState {
	 ...
	 *@invar Paddle enforcement in the gamefield| paddle.getPosition().getX()>=0 && paddle.getPosition().getY()>=0 && paddle.getPosition().getX()<=50000 && paddle.getPosition().getY()<=30000
	 @invar Ball enforcement in the game field|balls.stream().allMatch (e -> (e.getCenter().getX()<50000 && e.getCenter().getX()>0)&& (e.getCenter().getY()<30000 && e.getCenter().getY()>0))
	 @invar block enforcement in the game field|blocks.stream().allMatch (e -> ((e.getBlockBR().getX()<50000 && e.getBlockBR().getY()<30000)&&(e.getBlockTL().getX()<50000 && e.getBlockTL().getY()<30000)&& (e.getBlockTL().getY()>0 && e.getBlockTL().getX()>0)&& (e.getBlockBR().getY()>0 && e.getBlockBR().getX()>0)))
	)
	 *@representationObject
	 */
	private List <BallState> balls=new ArrayList <BallState>();
