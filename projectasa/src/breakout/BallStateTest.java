...
class BallStateTest {
	...
	void testInvalidArgumentsValueOfA() {
		...
		//BallState ballstate6=BallState.valueOfA(new Point(-250,-250),700,new Vector(5,7));
		//Correct Argument
		BallState ballstate7=BallState.valueOfA(new Point(70,70),700,new Vector(5,7));
	}
	@Test
	void testInvalidArgumentsValueOfB() {
		...
		//BallState ballstate6=BallState.valueOfB(new Point(-250,-250),new Vector(700/2,700/2),new Vector(5,7));
		
		//Correct Argument
		BallState ballstate7=BallState.valueOfB(new Point(70,70),new Vector(700/2,700/2),new Vector(5,7));
